...
INCEPTION_BLOCK_FILTER_SPECS = {
    ...
    '4a': [96, 96, 104, 16, 24, 32],
    '4b': [80, 112, 112, 24, 32, 32],
    '4c': [64, 128, 128, 24, 32, 32],
    '4d': [56, 144, 144, 32, 32, 32],
    '4e': [128, 160, 160, 32, 64, 64],
...
class I3DSmall(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, pretrained_net=None):
        ...
        self.inception_3a = InceptionBlock(192, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['3a']))
        self.inception_3b = InceptionBlock(256, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['3b']))

        self.maxpool_3 = nn.MaxPool3d((3, 3, 3), stride=2, padding=1)

        self.inception_4a = InceptionBlock(480, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['4a']))
        self.inception_4b = InceptionBlock(256, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['4b']))
        self.inception_4c = InceptionBlock(256, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['4c']))
        self.inception_4d = InceptionBlock(256, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['4d']))
        self.inception_4e = InceptionBlock(264, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['4e']))

        self.maxpool_4 = nn.MaxPool3d((2, 2, 2), stride=2)

        self.inception_5a = InceptionBlock(416, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['5a']))
        self.inception_5b = InceptionBlock(832, I3DSmall.build_filter_specs(INCEPTION_BLOCK_FILTER_SPECS['5b']))
